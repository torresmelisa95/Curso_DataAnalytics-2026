...
Modulo3 (ventas_tech_db.sql): Crea la base de datos, define las tablas relacionales con restricciones de integridad y carga datos iniciales.
Modulo4 (m4_consultas_negocio.sql): Ejecuta consultas de análisis sobre los datos.
Modulo5 (m5_consultas_joins.sql): Consultas avanzadas con JOINs entre múltiples tablas.
